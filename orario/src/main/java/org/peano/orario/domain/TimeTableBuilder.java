...
public class TimeTableBuilder {
	...
	private List<Timeslot> buildTimeSlotList() {
        ...
        slots.add( new Timeslot( DayOfWeek.FRIDAY, LocalTime.of(8, 0, 0), LocalTime.of(8, 50, 0), 1));
        slots.add( new Timeslot( DayOfWeek.FRIDAY, LocalTime.of(8, 55, 0), LocalTime.of(9, 45, 0), 2));
        slots.add( new Timeslot( DayOfWeek.FRIDAY, LocalTime.of(9, 50, 0), LocalTime.of(10, 40, 0), 3));
        slots.add( new Timeslot( DayOfWeek.FRIDAY, LocalTime.of(11, 10, 0), LocalTime.of(12, 0, 0), 4));
        slots.add( new Timeslot( DayOfWeek.FRIDAY, LocalTime.of(12, 5, 0), LocalTime.of(12, 55, 0), 5));
        //slots.add( new Timeslot( DayOfWeek.THURSDAY, LocalTime.of(13, 0, 0), LocalTime.of(13, 50, 0), 6));
        return slots;
	}
}
